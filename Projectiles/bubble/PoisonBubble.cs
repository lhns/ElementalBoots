...
namespace LolHens.Projectiles
{
    public class PoisonBubble : LolHensProjectile
    {
        ...
        public override void DamageNPC(NPC npc, int hitDir, ref int damage, ref float knockback, ref bool crit, ref float critMult) { if (toxic) npc.AddBuff(BuffDef.byName["Vanilla:Poisoned"], 300, false); }

        public override void DamagePlayer(Player p, int hitDir, ref int damage, ref bool crit, ref float critMult) { if (toxic) p.AddBuff(BuffDef.byName["Vanilla:Poisoned"], 300, false); }
