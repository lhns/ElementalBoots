...
namespace LolHens.Items
{
    public class Slingshot : LolHensItem
    {
        ...
        {
            textures[0] = modBase.textures["Items/slingshot/Slingshot"];
            textures[1] = modBase.textures["Items/slingshot/Slingshot2"];
            textures[2] = modBase.textures["Items/slingshot/Slingshot3"];
            textures[3] = modBase.textures["Items/slingshot/Slingshot4"];
            textures[4] = modBase.textures["Items/slingshot/Slingshot5"];
            textures[5] = modBase.textures["Items/slingshot/Slingshot6"];
            textures[6] = modBase.textures["Items/slingshot/Slingshot7"];
        }
